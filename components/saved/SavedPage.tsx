  ...
  return (
    <div className="w-full p-6 md:p-8 bg-background">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl md:text-3xl font-bold">Questões Salvas</h1>
      ...
      {savedQuestions.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium mb-2">Nenhuma questão salva</h3>
          <p className="text-muted-foreground">
            As questões que você salvar aparecerão aqui para revisão posterior.
          </p>
        </div>
      ) : (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-card border rounded-lg p-6 max-w-md mx-4">
            ...
            <p className="text-muted-foreground mb-6">
              Tem certeza que deseja remover {selectedToDelete.length} questão(ões) das salvas?
            </p>
